<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="font-bold text-2xl text-gray-900">Novo Hábito</h2>
                <p class="text-sm text-gray-600 mt-1">Defina um novo hábito para acompanhar</p>
            </div>
        </div>
    </x-slot>
                ...
                <form action="{{ route('habitos.store') }}" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ex: Beber água, Exercício, Ler...">
                        @error('nome')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <label class="relative flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-green-500 transition-colors">
                                <input type="radio" name="tipo" value="bom" class="sr-only peer" required {{ old('tipo') == 'bom' ? 'checked' : '' }}>
                            ...
                            <label class="relative flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-red-500 transition-colors">
                                <input type="radio" name="tipo" value="ruim" class="sr-only peer" {{ old('tipo') == 'ruim' ? 'checked' : '' }}>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="descricao" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                  placeholder="Adicione uma descrição ou motivação para este hábito...">{{ old('descricao') }}</textarea>
                        @error('descricao')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
