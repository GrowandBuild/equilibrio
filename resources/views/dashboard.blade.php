<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <button onclick="atualizarDia()" 
                                class="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white px-4 py-2 rounded-lg font-medium transition-all duration-200 shadow-md hover:shadow-lg flex items-center space-x-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" />
                            </svg>
                            <span>Atualizar Dia</span>
                        </button>
    ...
    {{-- JavaScript para atualizar o dia --}}
    <script>
        ...
        // Adiciona evento para forçar atualização dos componentes Livewire
        document.addEventListener('DOMContentLoaded', function() {
            // Emite evento para todos os componentes Livewire atualizarem
            Livewire.emit('refreshDay');
        });
    </script>
</x-app-layout>